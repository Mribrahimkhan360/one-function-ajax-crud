<div class="vertical-menu">
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span key="t-layouts">Merchant</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="true">
                        <li>
                            <a href="{{ route('merchant.manage') }}" key="t-vertical" id="merchantLink">Merchant List</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="bx bx-user"></i>
                        <span key="t-layouts">Merchant Two</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="true">
                        <li>
                            <a href="{{ route('merchant.manageTwo') }}" key="t-vertical" id="merchantLinkTwo">Merchant List Two</a>
                        </li>
                    </ul>
                </li>
            ...
            <ul class="metismenu list-unstyled" id="side-menus"></ul>
        </div>
        <!-- Sidebar -->
    </div>
</div>
