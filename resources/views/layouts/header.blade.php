            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box">
                    <a href="index.html" class="logo logo-dark">
                        <span class="logo-sm text-white" style="font-size: 1.5rem">
                                  <img src="{{asset('/')}}admin/assets/images/logo.svg" alt="" height="22">
{{--                                {{env('APP_NAME')}}--}}
                                </span>
                        <span class="logo-lg text-dark" style="font-size: 1.5rem">
                                 <img src="{{asset('/')}}admin/assets/images/logo-dark.png" alt="" height="17">
{{--                                {{env('APP_NAME')}}--}}
                        </span>
                    </a>

                    <a href="{{ url('/dashboard') }}" class="logo text-dark">
                        <span class="logo-sm text-white" style="font-size: 1.5rem">
                                 <img src="{{asset('/')}}admin/assets/images/logo-light.svg" alt="" height="22">
{{--                                {{env('APP_NAME')}}--}}
                        </span>
                        <span class="logo-lg text-white" style="font-size: 1.5rem">
...
{{--                                {{env('APP_NAME')}}--}}
    ...
    {{--    @extends('pages.partials.dashboard.rightsidebar')--}}
